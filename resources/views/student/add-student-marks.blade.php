...
@section('title', 'Add student Marks')
@push('css')
                        ...
                        <div class="card-body">
                            ...
                            <div id="" class="collapse show">
                                ...
                                <form class="form-horizontal" id="studentmarkform" method="post"
                                      action="{{ route('save-student-marks') }}" name="studentform"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" class="form-control" id="mark"
                                                           name="mark[{{ $value->id }}]" placeholder="mark" value="" onkeypress="return NumberOnly(event)">
