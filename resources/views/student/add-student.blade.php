                        ...
                        <div class="card-body">
                            ...
                            <div id="" class="collapse show">
                                ...
                                <form class="form-horizontal" id="studentform" method="post"
                                      action="{{ route('save-student') }}" name="studentform"
                                ...
                                <div class="fv-row mb-10">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control form-control-solid" id="name" placeholder="" name="name" value="" />
                                ...
                                <div class="fv-row mb-10">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control form-control-solid" placeholder="" name="age" value="" onkeypress="return NumberOnly(event)"/>
                                    ...
                                    <div class="fv-row mb-10">
                                        ...
                                        <select name="gender" class="form-control" id="gender">
                                            ...
                                            @foreach ($gender as $key => $value)
                                                <option value="{{ $value->id }}">{{ $value->gender_type }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                <!--end::Input group-->
